...
export default class Navigation extends React.Component {
  ...
  render() {
    return (
      <nav className="navbar navbar-default fadeInDown">
              ...
              {this.props.activeHomePage ? (
                <div>
                  <div
                    ...
                    className="btn btn-default button-shine"
                  >
                    Migrate
                  </div>
                  {this.props.activeHomePage && this.props.archiveActive ? (
                    <div>
                      {this.props.keyToHome ? (
                        <div
                          onClick={this.props.setHomeView}
                          className="btn btn-default button-shine glow-active"
                        >
                          Home
                        </div>
                      ) : (
                      ...
                      <div
                        onClick={this.props.setArchiveView}
                        className="btn btn-default button-shine active"
                      >
                        Archive
                      </div>
                    </div>
                  ...
                  <button
                    onClick={
                      this.props.instructionsModal
                        ? this.props.closeInstructionsModal
                        : this.props.openInstructionsModal
                    }
                    className="instruction-modal-btn"
                    title="Instructions"
                  >
                    ?
                  </button>
          ...
          <div className="collapse navbar-collapse" id="navbar-collapse">
            <ul className="nav navbar-nav navbar-right coin-amounts">
              ...
              <li>
                ...
                <span className="amount">${this.props.btcPrice}</span>
              </li>
            </ul>
          </div>
        </div>
