...
import { walletResetModal, walletResetModalStep } from "../../utils/modals";
...
export default class SelectWallet extends React.Component {
  constructor(props) {
    ...
    this.walletResetWarning1Proceed = this.walletResetWarning1Proceed.bind(
      this
    );
    this.walletResetWarning2Proceed = this.walletResetWarning2Proceed.bind(
      this
    );
    this.walletResetWarning3Proceed = this.walletResetWarning3Proceed.bind(
      this
    );
    this.walletResetWarning4Proceed = this.walletResetWarning4Proceed.bind(
      this
    );
    this.walletResetWarning5Proceed = this.walletResetWarning5Proceed.bind(
      this
    );
        ...
        show_options = (
          <div className="container">
            <div className="col-xs-12 Login-logo">
              ...
              <button
                className="back-button wallet-reset-button"
                onClick={
                  this.state.walletResetModal
                    ? this.walletResetClose
                    : this.walletResetStart
                }
              >
                Wallet Reset
              </button>
          ...
          <div className="container">
            {this.state.walletResetWarning1 ? (
              <div>
                <h3>
                  Wallet Reset
                  <span onClick={this.walletResetClose} className="close">
                    X
                  </span>
                </h3>
                <p>{this.state.walletResetModalText}</p>
                <button
                  className="keys-btn button-shine"
                  onClick={this.walletResetWarning1Proceed}
                >
                  Proceed
                </button>
              </div>
            ...
            {this.state.walletResetWarning2 ? (
              <div>
                ...
                <button
                  className="keys-btn button-shine"
                  onClick={this.walletResetWarning2Proceed}
                >
                  Proceed
                </button>
              </div>
            ...
            {this.state.walletResetWarning3 ? (
              <div>
                ...
                <button
                  className="keys-btn button-shine"
                  onClick={this.walletResetWarning3Proceed}
                >
                  Proceed
                </button>
              </div>
            ...
            {this.state.walletResetWarning4 ? (
              <div>
                ...
                <button
                  className="keys-btn button-shine"
                  onClick={this.walletResetWarning4Proceed}
                >
                  Proceed
                </button>
              </div>
            ...
            {this.state.walletResetWarning5 ? (
              <div>
                ...
                <button
                  className="keys-btn button-shine"
                  onClick={this.walletResetWarning5Proceed}
                >
                  Proceed
                </button>
              </div>
            ...
            {this.state.walletResetModal1 ? (
              <div>
                ...
                <button
                  className="keys-btn button-shine"
                  onClick={this.walletResetStep1Skip}
                >
                  Skip
                </button>
                <button
                  className="keys-btn button-shine"
                  onClick={this.walletResetStep1Proceed}
                >
                  Proceed
                </button>
              </div>
            ...
            {this.state.walletResetModal2unencrypted ? (
              <div>
                ...
                <form
                  ...
                  onSubmit={this.walletResetDlUnencrypted}
                >
                  <input
                    className={
                      this.state.wrong_password
                        ? "form-control password-btn shake"
                        : "form-control password-btn"
                    }
                    type="password"
                    name="password"
                    ...
                    autoFocus
                  />
                  <button className="keys-btn button-shine" type="submit">
                    Proceed
                  </button>
                </form>
              </div>
            ...
            {this.state.walletResetModalDlUnencrypted ? (
              <div>
                ...
                <form onSubmit={this.walletResetDlEncrypted}>
                  <label>
                    <input name="checkbox" type="checkbox" />I understand that
                    this is my last chance to backup my wallet file after this
                    it will be deleted
                  </label>
