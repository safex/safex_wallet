      ...
      <div className="step-one">
        ...
        <p>
          ...
          <input
            type="text"
            className="red-input"
            defaultValue="Safe Exchange Coins"
            readOnly
          />{" "}
          from the Bitcoin blockchain to the Safex blockchain.
        </p>
        <p>
        ...
        <p>
          ...
          <input
            type="text"
            className="blue-input"
            defaultValue="~0.0023 Safex Cash "
            readOnly
          />
          <input
            type="text"
            className="blue-input"
            defaultValue="Safex Cash (SFX)"
            readOnly
          />{" "}
        ...
        <p>
          ...
          Fees covered on your own.
        </p>
        <p>
          This procedure will last only for 1 year, until Block 260,000 - after
          this time no Safe Exchnage Coins will be accepted for migration. Any
          unclaimed SFX Airdrop will be absorbed by the Safex Developers.
        </p>
